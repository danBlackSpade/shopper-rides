...
export default function RequestRide() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const googleMapsUrl = `https://maps.googleapis.com/maps/api/staticmap?size=600x400&markers=color:blue%7Clabel:A%7C${origin}&markers=color:red%7Clabel:B%7C${destination}&path=color:0x0000ff|weight:3|${origin}|${destination}&key=${process.env.NEXT_PUBLIC_GOOGLE_API_KEY}`;
